...
namespace PKHeX.WinForms
{
    public partial class SAV_Misc5 : Form
    {
        ...
        private void ReadMain()
        {
            ...
            if (SAV.AllBlocks is SaveBlockAccessor5BW)
            {
            ...
            else if (SAV.AllBlocks is SaveBlockAccessor5B2W2)
            {
        ...
        {
            var source = (SAV.AllBlocks is SaveBlockAccessor5B2W2 ? Encounters5.B2W2_DreamWorld : Encounters5.BW_DreamWorld).ToList();
