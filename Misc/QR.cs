...
namespace PKHeX
{
    ...
    {
        public QR(byte[] data, Image pkm, string top, string bottom, string left, string right)
        {
            InitializeComponent();
    ...
    /// QR Code / Image Generation code via codebude/QRCoder on GitHub.
    /// https://github.com/codebude/QRCoder
    /// The QRCoder project is authored by Raffael Herrmann, licensed under the MIT License.
    /// License: https://github.com/codebude/QRCoder/blob/master/LICENSE.txt
