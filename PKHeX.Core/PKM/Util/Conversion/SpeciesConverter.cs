...
public static class SpeciesConverter
{
    ...
    public static byte SetG1Species(ushort species) => species >= table1_Internal.Length ? (byte)0 : table1_Internal[species];
    ...
    public static ushort GetG3Species(ushort species) => species >= table3_Internal.Length ? (ushort)0 : table3_Internal[species];
