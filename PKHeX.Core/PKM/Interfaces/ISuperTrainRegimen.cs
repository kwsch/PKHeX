...
public static class SuperTrainRegimenExtensions
{
    ...
    extension(ISuperTrainRegimen sr)
    {
        public bool GetRegimenState(int index) => (uint)index switch
        {
        ...
        public bool SetRegimenState(int index, bool value) => (uint)index switch
        {
        ...
        public bool GetRegimenStateDistribution(int index) => (uint)index switch
        {
        ...
        public bool SetRegimenStateDistribution(int index, bool value) => (uint)index switch
        {
