...
namespace PKHeX.Core
{
        ...
        IContestStats, IContestStatsMutable, IGroundTile
    {
        ...
        public override Span<byte> Nickname_Trash { get => Data.AsSpan(0x48, strlen_n); set { if (value.Length <= strlen_n) value.CopyTo(Data.AsSpan(0x48)); } }
        public override Span<byte> OT_Trash { get => Data.AsSpan(0x68, strlen_o); set { if (value.Length <= strlen_o) value.CopyTo(Data.AsSpan(0x68)); } }
