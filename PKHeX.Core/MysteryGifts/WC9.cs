    ...
    IRibbonSetCommon8, IRibbonSetMark8, IRibbonSetCommon9, IRibbonSetMark9, IEncounterMarkExtra
{
    ...
    public ushort Scale
    {
        get => ReadUInt16LittleEndian(Data[(CardStart + 0x0C)..]);
        set => WriteUInt16LittleEndian(Data[(CardStart + 0x0C)..], value);
    }
    ...
    public int GetItem(int index) => ReadUInt16LittleEndian(Data[(CardStart + 0x18 + (0x4 * index))..]);
    public void SetItem(int index, ushort item) => WriteUInt16LittleEndian(Data[(CardStart + 0x18 + (4 * index))..], item);
    public int GetQuantity(int index) => ReadUInt16LittleEndian(Data[(CardStart + 0x1A + (0x4 * index))..]);
    public void SetQuantity(int index, ushort quantity) => WriteUInt16LittleEndian(Data[(CardStart + 0x1A + (4 * index))..], quantity);
    ...
    {
        get => ReadUInt32LittleEndian(Data[(CardStart + 0x18)..]);
        set => WriteUInt32LittleEndian(Data[(CardStart + 0x18)..], value);
    }

    public uint ID32Old
    {
        get => ReadUInt32LittleEndian(Data[(CardStart + 0x18)..]) - (1000000u * (uint)CardID);
        set => WriteUInt32LittleEndian(Data[(CardStart + 0x18)..], value + (1000000u * (uint)CardID));
    }
    ...
    {
        get => ReadInt32LittleEndian(Data[(CardStart + 0x1C)..]);
        set => WriteInt32LittleEndian(Data[(CardStart + 0x1C)..], value);
    }
    ...
    public uint PID
    {
        get => ReadUInt32LittleEndian(Data[(CardStart + 0x24)..]);
        set => WriteUInt32LittleEndian(Data[(CardStart + 0x24)..], value);
    }

    // Nicknames, OT Names 0x28 - 0x220
    public override ushort EggLocation { get => ReadUInt16LittleEndian(Data[(CardStart + 0x220)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x220)..], value); }
    public override ushort Location { get => ReadUInt16LittleEndian(Data[(CardStart + 0x222)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x222)..], value); }

    public override byte Ball
    {
        get => (byte)ReadUInt16LittleEndian(Data[(CardStart + 0x224)..]);
        set => WriteUInt16LittleEndian(Data[(CardStart + 0x224)..], value);
    }

    public override int HeldItem
    {
        get => ReadUInt16LittleEndian(Data[(CardStart + 0x226)..]);
        set => WriteUInt16LittleEndian(Data[(CardStart + 0x226)..], (ushort)value);
    }

    public ushort Move1 { get => ReadUInt16LittleEndian(Data[(CardStart + 0x228)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x228)..], value); }
    public ushort Move2 { get => ReadUInt16LittleEndian(Data[(CardStart + 0x22A)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x22A)..], value); }
    public ushort Move3 { get => ReadUInt16LittleEndian(Data[(CardStart + 0x22C)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x22C)..], value); }
    public ushort Move4 { get => ReadUInt16LittleEndian(Data[(CardStart + 0x22E)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x22E)..], value); }
    public ushort RelearnMove1 { get => ReadUInt16LittleEndian(Data[(CardStart + 0x230)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x230)..], value); }
    public ushort RelearnMove2 { get => ReadUInt16LittleEndian(Data[(CardStart + 0x232)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x232)..], value); }
    public ushort RelearnMove3 { get => ReadUInt16LittleEndian(Data[(CardStart + 0x234)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x234)..], value); }
    public ushort RelearnMove4 { get => ReadUInt16LittleEndian(Data[(CardStart + 0x236)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x236)..], value); }

    public override ushort Species { get => SpeciesConverter.GetNational9(ReadUInt16LittleEndian(Data[(CardStart + 0x238)..])); set => WriteUInt16LittleEndian(Data[(CardStart + 0x238)..], SpeciesConverter.GetInternal9(value)); }
    ...
    public short HeightValue { get => ReadInt16LittleEndian(Data[(CardStart + 0x244)..]); set => WriteInt16LittleEndian(Data[(CardStart + 0x244)..], value); }
    public short WeightValue { get => ReadInt16LittleEndian(Data[(CardStart + 0x246)..]); set => WriteInt16LittleEndian(Data[(CardStart + 0x246)..], value); }
    ...
    public ushort OriginalTrainerMemoryVariable { get => ReadUInt16LittleEndian(Data[(CardStart + 0x278)..]); set => WriteUInt16LittleEndian(Data[(CardStart + 0x278)..], value); }

    public ushort Checksum => ReadUInt16LittleEndian(Data[0x2C4..]);
