...
{
    private readonly MemeKeyIndex Key;

    private ReadOnlySpan<byte> DER => GetMemeData(Key);
    ...
    private static ReadOnlySpan<byte> GetMemeData(MemeKeyIndex key) => key switch
    {
