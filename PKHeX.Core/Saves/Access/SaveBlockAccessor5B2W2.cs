...
namespace PKHeX.Core
{
    ...
    public sealed class SaveBlockAccessor5B2W2 : ISaveBlockAccessor<BlockInfoNDS>, ISaveBlock5BW, ISaveBlock5B2W2
    {
        private static readonly BlockInfoNDS[] BlocksB2W2 =
        {
            ...
            new(0x1DA00, 0x01e0, 0x1DBE2, 0x25F4C), // 38 Record
            ...
            new(0x20400, 0x00f8, 0x204FA, 0x25F5C), // 46 ???
            new(0x20500, 0x02fc, 0x207FE, 0x25F5E), // 47 Regulation
            ...
            new(0x20F00, 0x01e0, 0x210E2, 0x25F66), // 51 Strength Boulder Status Block
            ...
            new(0x23300, 0x0284, 0x23586, 0x25F7A), // 61 ???
            new(0x23600, 0x0010, 0x23612, 0x25F7C), // 62 ???
            ...
            new(0x25A00, 0x03e4, 0x25DE6, 0x25F8E), // 71 ???
