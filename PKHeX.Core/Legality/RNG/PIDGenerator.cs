...
public static class PIDGenerator
{
    ...
    public static void SetRandomPokeSpotPID(PKM pk, int nature, byte gender, int ability, int slot)
    {
        var rnd = Util.Rand;
        while (true)
        {
    ...
    public static uint SetRandomWildPID4(PKM pk, int nature, int ability, byte gender, PIDType type)
    {
    ...
    public static bool IsValidCriteria4(PKM pk, int nature, int ability, byte gender)
    {
    ...
    public static void SetRandomWildPID5(PKM pk, int nature, int ability, byte gender, PIDType specific = PIDType.None)
    {
