    ...
    internal static class EncountersWC3
    {
        ...
        private static IEnumerable<MysteryGift> GetIngameCXDData()
        {
            ...
            IEnumerable<WC3> GetIngame(int l)
            {
                ...
                return new[]
                {
                    new WC3 { Species = 239, Level = 20, Language = l, Location = 164, TID = 41400, SID = -1, OT_Gender = 0, OT_Name = h[l], Version = GameVersion.XD,   CardTitle = $"Trade Togepi ({id})",     Method = PIDType.CXD, Shiny = Shiny.Never, Moves = new[] { 008, 007, 009, 238 } }, // Elekid @ Snagem Hideout
