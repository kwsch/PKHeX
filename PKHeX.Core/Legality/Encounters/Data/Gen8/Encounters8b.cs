...
public static class Encounters8b
{
    ...
    public static readonly EncounterArea8b[] SlotsBD = [..SlotsBD_OW, ..SlotsBD_UG];
    public static readonly EncounterArea8b[] SlotsSP = [..SlotsSP_OW, ..SlotsSP_UG];

    public static readonly EncounterStatic8b[] Encounter_BDSP =
    [
        // Gifts
    ...
    public static readonly EncounterStatic8b[] StaticBD =
    [
    ...
    public static readonly EncounterStatic8b[] StaticSP =
    [
    ...
    public static readonly EncounterTrade8b[] TradeGift_BDSP =
    [
