...
namespace PKHeX.Core
{
    internal static class Encounters7b
    {
        ...
        private static readonly EncounterStatic[] Encounter_GG =
        {
            ...
            new EncounterStatic { Species = 131, Level = 34, Location = 52, Gift = true, IVs = new[] {31,25,25,25,30,30} }, // Lapras @ Saffron City (Silph Co. Employee)
            ...
            new EncounterStatic { Species = 137, Level = 34, Location = 52, Gift = true, IVs = new[] {25,25,30,25,31,30} }, // Porygon @ Saffron City (Silph Co. Employee)
