...
namespace PKHeX.Core
{
    ...
    internal static class Encounters7
    {
        ...
        private static readonly EncounterStatic7[] Encounter_SM = // @ a\1\5\5
        {
            ...
            new EncounterStatic7 { Species = 793, Level = 55, Shiny = Shiny.Never, Ability = 1, Location = 100, FlawlessIVCount = 3, }, // Nihilego @ Diglett’s Tunnel
        ...
        private static readonly EncounterStatic7[] Encounter_USUM =
        {
            ...
            new EncounterStatic7 { Species = 760, Level = 28, Location = 020, Shiny = Shiny.Never, }, // Bewear @ Hau’oli City (Shopping District)
