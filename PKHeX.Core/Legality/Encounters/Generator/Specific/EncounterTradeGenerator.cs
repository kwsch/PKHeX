...
namespace PKHeX.Core
{
    ...
    {
        public static IEnumerable<EncounterTrade> GetPossible(PKM pkm, EvoCriteria[] chain, GameVersion gameSource)
        {
        ...
        public static IEnumerable<EncounterTradeGB> GetValidEncounterTradesVC(PKM pkm, EvoCriteria[] chain, GameVersion game)
        {
            var table = GetTableVC(game);
        ...
        private static IEnumerable<EncounterTrade> GetValidEncounterTrades(PKM pkm, EvoCriteria[] chain, EncounterTrade[] poss)
        {
