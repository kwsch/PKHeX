...
public readonly record struct EncounterCriteria : IFixedNature, IFixedAbilityNumber, IShinyPotential, ILevelRange
{
    ...
    /// <summary>
    /// Determines whether the number of specified IVs is less than the given count.
    /// </summary>
    /// <param name="count">The maximum number of specified IVs to check for.</param>
    /// <returns>><see langword="true"/> if the number of specified IVs is less than <paramref name="count"/>; otherwise, <see langword="false"/>.</returns>
