...
{
    public static DateOnly GetDateNDS() => DateOnly.FromDateTime(DateTime.Now);
    public static DateOnly GetDate3DS() => DateOnly.FromDateTime(DateTime.Now);
    public static DateOnly GetDateSwitch() => DateOnly.FromDateTime(DateTime.Now);
}
