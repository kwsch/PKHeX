...
public sealed record EncounterSlot9(EncounterArea9 Parent, ushort Species, byte Form, byte LevelMin, byte LevelMax, sbyte Gender, byte Time)
    : EncounterSlot, IEncounterConvertible<PK9>, ILevelRange, IEncounterFormRandom
{
    ...
    public PK9 ConvertToPKM(ITrainerInfo tr, EncounterCriteria criteria)
    {
        ...
        pk.OT_Friendship = PersonalTable.SV[Species, pk.Form].BaseFriendship;
        pk.Obedience_Level = LevelMin;
