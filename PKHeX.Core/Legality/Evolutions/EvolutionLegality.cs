...
internal static class EvolutionLegality
{
    ...
    private static readonly HashSet<ushort> FutureEvolutionsGen2 = new()
    {
        (int)Species.Ambipom,
    ...
    private static readonly HashSet<ushort> FutureEvolutionsGen3 = new()
    {
    ...
    private static readonly ushort[] FutureEvolutionsGen4 =
    {
        (int)Species.Sylveon,
    };

    private static readonly ushort[] FutureEvolutionsGen5 = FutureEvolutionsGen4;

    internal static ICollection<ushort> GetFutureGenEvolutions(int generation) => generation switch
    {
