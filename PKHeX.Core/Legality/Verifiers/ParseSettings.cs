...
public static class ParseSettings
{
    ...
    public static IEnumerable<string> GetMoveNames(IEnumerable<ushort> moves) => moves.Select(m => (uint)m >= MoveStrings.Count ? LegalityCheckStrings.L_AError : MoveStrings[m]);
