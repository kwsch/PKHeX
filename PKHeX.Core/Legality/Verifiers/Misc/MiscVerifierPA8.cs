...
internal sealed class MiscVerifierPA8 : Verifier
{
    ...
    private static bool IsAbsoluteEdgeCase(LegalityAnalysis data, PA8 pk)
    {
        ...
        if (enc is EncounterStatic8a { IsAlpha127: true }) 
            return IsAbsolute127(pk); // 127-127 and 255-255 can match 127.
        ...
        // Starting in HOME 4.0.0, the app uses FMADD (Fused Multiply Add) for size calculations, which differs from in-game step-by-step math, for 30 of 256 scalars.
    ...
    private static bool IsAbsolute127(PA8 pk)
    {
