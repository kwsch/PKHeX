...
{
    internal static ReadOnlySpan<byte> TMHM_GSC => new byte[]
    {
    ...
    internal static ReadOnlySpan<byte> Tutors_GSC => new byte[] { (int)Move.Flamethrower, (int)Move.Thunderbolt, (int)Move.IceBeam };
}
