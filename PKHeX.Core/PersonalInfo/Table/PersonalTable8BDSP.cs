...
public sealed class PersonalTable8BDSP : IPersonalTable, IPersonalTable<PersonalInfo8BDSP>
{
    ...
    public PersonalInfo8BDSP this[ushort species, int form] => Table[GetFormIndex(species, form)];
    public PersonalInfo8BDSP GetFormEntry(ushort species, int form) => Table[GetFormIndex(species, form)];
