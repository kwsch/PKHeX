...
public sealed class PersonalTable6XY : IPersonalTable, IPersonalTable<PersonalInfo6XY>
{
    ...
    public PersonalInfo6XY this[ushort species, int form] => Table[GetFormIndex(species, form)];
    public PersonalInfo6XY GetFormEntry(ushort species, int form) => Table[GetFormIndex(species, form)];
