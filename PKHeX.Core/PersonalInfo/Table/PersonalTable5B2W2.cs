...
public sealed class PersonalTable5B2W2 : IPersonalTable, IPersonalTable<PersonalInfo5B2W2>
{
    ...
    public PersonalInfo5B2W2 this[ushort species, int form] => Table[GetFormIndex(species, form)];
    public PersonalInfo5B2W2 GetFormEntry(ushort species, int form) => Table[GetFormIndex(species, form)];
