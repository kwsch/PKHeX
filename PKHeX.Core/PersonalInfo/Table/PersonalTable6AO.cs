...
public sealed class PersonalTable6AO : IPersonalTable, IPersonalTable<PersonalInfo6AO>
{
    ...
    public PersonalInfo6AO this[ushort species, int form] => Table[GetFormIndex(species, form)];
    public PersonalInfo6AO GetFormEntry(ushort species, int form) => Table[GetFormIndex(species, form)];
