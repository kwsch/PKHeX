...
public sealed class PersonalTable4 : IPersonalTable, IPersonalTable<PersonalInfo4>
{
    ...
    public PersonalInfo4 this[ushort species, int form] => Table[GetFormIndex(species, form)];
    public PersonalInfo4 GetFormEntry(ushort species, int form) => Table[GetFormIndex(species, form)];
