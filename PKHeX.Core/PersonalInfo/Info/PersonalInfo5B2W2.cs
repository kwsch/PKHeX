...
/// </summary>
public sealed class PersonalInfo5B2W2(Memory<byte> Raw) : PersonalInfo, IPersonalAbility12H, IPersonalInfoTM, IPersonalInfoTutorType
{
    ...
    {
        var span = Data.Slice(TMHM, ByteCountTMHM);
    ...
    public static ReadOnlySpan<ushort> TutorMoves1 =>[ 450, 343, 162, 530, 324, 442, 402, 529, 340, 067, 441, 253, 009, 007, 008 ]; // Driftveil
    public static ReadOnlySpan<ushort> TutorMoves2 =>[ 277, 335, 414, 492, 356, 393, 334, 387, 276, 527, 196, 401, 399, 428, 406, 304, 231 ]; // Lentimas
    public static ReadOnlySpan<ushort> TutorMoves3 =>[ 020, 173, 282, 235, 257, 272, 215, 366, 143, 220, 202, 409, 355 ]; // Humilau
    public static ReadOnlySpan<ushort> TutorMoves4 =>[ 380, 388, 180, 495, 270, 271, 478, 472, 283, 200, 278, 289, 446, 214, 285 ]; // Nacrene
