...
namespace PKHeX.Core
{
    public class PK3 : PKM // 3rd Generation PKM File
    {
        ...
        public override int Ability { get { int[] abils = PersonalInfo.Abilities; return abils[abils[1] == 0 ? 0 : AbilityBit]; } set { } }
        ...
        public byte AbilityBit { get { return (byte)(IV32 >> 31); } set { IV32 = (IV32 & 0x7FFFFFFF) | (uint)(value << 31); } }
