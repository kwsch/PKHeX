...
namespace PKHeX.Core
{
    public static partial class Legal
    {
        ...
        internal static readonly EncounterTrade[] TradeGift_HGSS =
        {
            ...
            new EncounterTrade { Species = 111, Ability = 1, TID = 06845, SID = 00000, OTGender = 0, Gender = 1, IVs = new[] {22,31,13,00,22,09}, Nature = Nature.Relaxed, Moves= new[]{422,-1,-1,-1} }, // Rhyhorn
