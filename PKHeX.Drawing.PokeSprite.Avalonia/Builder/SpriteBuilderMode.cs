using PKHeX.Core;
using static PKHeX.Drawing.PokeSprite.Avalonia.SpriteBuilderMode;
using static PKHeX.Drawing.PokeSprite.Avalonia.SpriteBuilderPreference;
...
public static class SpriteBuilderUtil
{
    ...
    public static SpriteBuilderMode GetSuggestedMode(SaveFile sav) => SpriterPreference switch
    {
        ...
        _ => sav switch // Default, suggest.
        {
            ...
            SAV9SV or SAV9ZA => SpritesArtwork5668,
