...
public sealed class SpriteBuilder5668s : SpriteBuilder
{
    ...
    protected override string GetSpriteAll(ushort species, int form, int gender, uint formarg, bool shiny, int generation) => 'b' + SpriteName.GetResourceStringSprite(species, form, gender, formarg, generation, shiny);
    protected override string GetSpriteAllSecondary(ushort species, int form, int gender, uint formarg, bool shiny, int generation) => 'c' + SpriteName.GetResourceStringSprite(species, form, gender, formarg, generation, shiny);
