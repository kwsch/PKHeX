...
public class PackagingIdentityTests
{
    ...
    public void WindowsPackaging_UsesPublicApplicationIdentity()
    {
        ...
        var wingetLocale = ReadRepositoryFile("packaging", "winget", "doctorllll.PKHeXAvalonia.locale.en-US.yaml");
        var wingetVersion = ReadRepositoryFile("packaging", "winget", "doctorllll.PKHeXAvalonia.yaml");
        var wingetInstaller = ReadRepositoryFile("packaging", "winget", "doctorllll.PKHeXAvalonia.installer.yaml");
        ...
        AssertHasLine(installer, "#define MyAppURL \"https://github.com/doctorllll/PKHeX\"");
        ...
        foreach (var manifest in new[] { wingetLocale, wingetVersion, wingetInstaller })
            AssertHasLine(manifest, "PackageIdentifier: doctorllll.PKHeXAvalonia");

        AssertHasLine(wingetLocale, "Publisher: Patrik Lleshaj");
        AssertHasLine(wingetLocale, "PublisherUrl: https://github.com/doctorllll");
        AssertHasLine(wingetLocale, "PublisherSupportUrl: https://github.com/doctorllll/PKHeX/issues");
        AssertHasLine(wingetLocale, "PackageName: PKHeX-Avalonia");
        AssertHasLine(wingetLocale, "PackageUrl: https://github.com/doctorllll/PKHeX");
        AssertHasLine(wingetLocale, "LicenseUrl: https://github.com/doctorllll/PKHeX/blob/master/LICENSE");
        AssertHasLine(wingetInstaller, "InstallerUrl: https://github.com/doctorllll/PKHeX/releases/download/v{{VERSION}}/PKHeX-Avalonia-Setup.exe");
